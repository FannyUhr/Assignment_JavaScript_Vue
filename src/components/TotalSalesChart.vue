      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-wrap mb-4 mt-4 pb-4">
          <div class="mr-4 mr-md-5">
            ...
            <h4>{{ totalSalesChart.revenue }}</h4>
          </div>
          <div class="mr-4 mr-md-5">
            <p class="mb-0">Returns</p>
            <h4>{{ totalSalesChart.returns }}</h4>
          </div>
          <div class="mr-4 mr-md-5">
            <p class="mb-0">Queries</p>
            <h4>{{ totalSalesChart.queries }}</h4>
          </div>
          <div class="mr-4 mr-md-5">
            <p class="mb-0">Invoices</p>
            <h4>{{ totalSalesChart.invoices }}</h4>
          </div>
        </div>
